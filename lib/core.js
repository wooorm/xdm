 ...
 * @property {Array<string>} [mdExtensions] Extensions (with `.`) for markdown
 * @property {Array<string>} [mdxExtensions] Extensions (with `.`) for MDX
 ...
 * @property {RemarkRehypeOptions} [remarkRehypeOptions] Options to pass through to `remark-rehype`.
 *

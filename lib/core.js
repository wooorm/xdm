...
import {recmaVueJsxBuild} from './plugin/recma-vue-jsx-build.js'
import {recmaVueComponent} from './plugin/recma-vue-component.js'
...
export function createProcessor(options = {}) {
  ...
  pipeline
    .use(rehypeRecma)
    .use(recmaVueComponent)

  if (!jsx) {
    pipeline.use(recmaVueJsxBuild)
  }

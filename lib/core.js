...
function createProcessor(options = {}) {
  ...
  return (
    unified()
      ...
      // @ts-ignore recma transformer uses a periscope node rather than a unist node
      .use(recmaJsxRewrite, {providerImportSource, contain})
      .use(jsx ? undefined : recmaJsxBuild, {contain})
      // @ts-ignore TODO figure out why recma isn't being recognized as a stringifier plugin

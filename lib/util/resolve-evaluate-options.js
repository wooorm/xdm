 ...
 *
 * @typedef {Omit<ProcessorOptions, 'jsx' | 'jsxImportSource' | 'jsxRuntime' | 'pragma' | 'pragmaFrag' | 'pragmaImportSource' | 'providerImportSource' | '_baseUrl' | '_contain'> } EvaluateProcessorOptions
 *
...
export function resolveEvaluateOptions(options) {
  var {Fragment, jsx, jsxs, useMDXComponents, baseUrl, ...rest} = options || {}

...
test('jsx', async (t) => {
  ...
  t.equal(
    ...
    [
      '/*@jsxRuntime automatic @jsxImportSource react*/',
      'function MDXContent(props) {',
      '  const _components = Object.assign({}, props && props.components), {wrapper: MDXLayout} = _components;',
  ...
  t.equal(
    ...
    [
      '/*@jsxRuntime automatic @jsxImportSource react*/',
      'function MDXContent(props) {',
      '  const _components = Object.assign({}, props && props.components), {wrapper: MDXLayout, c} = _components;',
